...
int in1 = 9;                 // Pin to control positive direction of rotation of inlet motor.
int in2 = 8;                 // Pin to control negative direction of rotation of inlet motor
int in3 = 7;                 // Pin to control positive direction of rotation of outlet motor
//int in4 = 6;                 // Pin to control negative direction of rotation of outlet motor
AD9833 gen(FNC_PIN);         // Configure the AD9833 FNC Pin
float pwm=1;                 // Initial freqeuncy of 1 Hz
float value_del=1;           // Initial delta time
int deltaT=1000;             // Measurement time for frequency counter (1000000= 1 s)
int timepump=0;              // Compare times to indicate how long the pump will run
int mode=0;
...
void fnReading(String cad){                  // Define function for reading serial communication 
  ...
  if (label.equals("del")){                  // Label "del" refers to delta of time       
    ...
    deltaT=value_del*1000;                // Conversion factor
